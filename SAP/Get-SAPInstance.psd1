@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            #ProjectUri = 'https://gitlab/devops/OXSAPAdmin'

            # A URL to an icon representing this module.
            #IconUri = 'https://gitlab/devops/OXSAPAdmin'
...
RootModule = 'Get-SAPInstance.psm1'

# Version number of this module.
ModuleVersion = '1.0.0'

# ID used to uniquely identify this module
GUID = '6a1ac81e-b66b-4aca-bbd9-616c6bc4033c'
...
Description = 'Oxya Admin related functions for US SAP Team'
